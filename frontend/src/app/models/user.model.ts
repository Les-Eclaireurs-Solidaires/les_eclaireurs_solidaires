import { InvalidUserRoleError } from '../exceptions/invalid-user-role-error';
...
export interface IUserFromBack {
  uuid: string;
  email: string;
  firstName?: string;
  lastName?: string;
...
export class UserModel {
  ...
  private constructor(data: IUserFromBack) {
    this.uuid = data.uuid;
  ...
  public static reconstitute(data: IUserFromBack): UserModel {
    return new UserModel(data);
  }
  public toJSON(): IUserFromBack {
    return {
      uuid: this.uuid,
      email: this.email,
